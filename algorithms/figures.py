...
def compare_efficiency():
    ...
    for dna_len in range(10, 601, 10): # 10, 601, 10
        ...
        for _ in range(10):
            start = time.time()
            main_extension('../datasets/extension_3.txt', BLOSUM62(), -15, -2, auto_bound=True)
...
def comparing_optimal_scores(repeat, dna_len, auto_bound):
    ...
    for divisor in np.linspace(1,3,21): # 1,3,21
        ...
        for _ in range(repeat):
            ...
            print("Bounded dynamic programming: ")
            max_score, _, _ = main_extension('../datasets/extension_3.txt', BLOSUM62(), -15, -2,
                                             bound=10, auto_bound=auto_bound)
...
if __name__ == '__main__':
    ...
    comparing_optimal_scores(50, 100, True)
